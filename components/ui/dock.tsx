  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          'mx-auto flex w-fit items-center gap-4 rounded-full bg-gray-50 px-6 dark:bg-neutral-900',
          className
        )}
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            'absolute -top-9 left-1/2 w-fit whitespace-pre rounded-md border border-gray-200 bg-gray-100 px-3 py-1.5 text-base text-neutral-700 dark:border-neutral-900 dark:bg-neutral-800 dark:text-white',
            className
          )}
          role='tooltip'
          style={{ x: '-50%' }}
